...
class FillDeposit(PreProcessInterface):
    ...
    def fill_test_deposit_from_train(self):
        ...
        same_group_and_area = train_data[(train_data['apt_idx'] == row['apt_idx']) &
    ...
    def revert_5_percent_increased_values(self):
        ...
        self.df.loc[self.df['is_increased'] == True, 'deposit'] = self.df.loc[self.df['is_increased'] == True, 'deposit'] / 1.05
        return self.df